...
// SharedBoard
$routes->add('board/share', 'master\bShare::getBoard');
$routes->add('board/shareCount', 'master\bShare::count');
$routes->add('board/share/add', 'master\bShare::addShared');
$routes->add('board/share/delete', 'master\bShare::shareDelete');
// Task
